...
#   "1 321,49"   partner exports, amounts >= 1000 (European thousands
#                separator - a whitespace character, typically a
#                non-breaking space, not a plain ".")
#   "-8.00"      refunds
...
def parse_amount(raw: str) -> Decimal:
    ...
    if raw is None:
        return ZERO
    # Strip whitespace used as a thousands separator (e.g. partner exports'
    # "1\xa0321,49") before matching - otherwise the regex only matches the
    # leading digits ahead of the separator and silently truncates the value.
